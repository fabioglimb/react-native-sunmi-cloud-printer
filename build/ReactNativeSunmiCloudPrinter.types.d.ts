...
type SunmiErrorType = 'ERROR_INVALID_INTERFACE' | 'ERROR_IMAGE_NOT_VALID' | 'ERROR_IMAGE_SIZE_NOT_VALID' | 'ERROR_PRINTER_NOT_CONNECTED' | 'ERROR_INVALID_PERMISSIONS' | 'ERROR_UNSUPPORTED_PLATFORM';
export declare class SunmiError extends Error {
    code?: SunmiErrorType;
    message: string;
...
export {};
//# sourceMappingURL=ReactNativeSunmiCloudPrinter.types.d.ts.map